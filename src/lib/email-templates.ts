export const welcomeEmailTemplate = (email: string, confirmationToken?: string) => {
  const confirmationUrl = confirmationToken 
    ? `${process.env.APP_URL}/api/newsletter/confirm?token=${confirmationToken}`
    : null;
                    ...
                    <td style="padding: 20px 40px;">
                      ...
                      ${confirmationUrl ? `
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                          <tr>
                            <td align="center">
                              <a href="${confirmationUrl}" style="display: inline-block; padding: 14px 32px; background-color: #3b82f6; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600;">
                                Confirmar mi email
                              </a>
                            </td>
                          </tr>
                  ...
                  <tr>
                    <td style="padding: 20px 40px;">
                      ...
                      <ul style="margin: 0; padding: 0 0 0 20px; color: #4a5568; font-size: 15px; line-height: 1.8;">
                        <li>Tips semanales y recursos exclusivos</li>
