...
export default function Footer() {
  ...
  const igUrl = pathname?.startsWith('/microcluster')
  ? 'https://www.instagram.com/microclusterok/'
  : 'https://www.instagram.com/festivalcluster/';
  
  const fbUrl = pathname?.startsWith('/microcluster')
  ? 'https://www.facebook.com/profile.php?id=61576445061123'
  : 'https://www.facebook.com/profile.php?id=61578553811252';
    ...
    <footer className={styles.foot}>
      ...
      <div className={styles.footerContainer}>
        ...
        <div>
          ...
          <ul>
            <li><Link href={igUrl} target="_blank" rel="noopener noreferrer">Instagram</Link></li>
            <li>X</li>
            <li><Link href={fbUrl} target="_blank" rel="noopener noreferrer">Facebook</Link></li>
